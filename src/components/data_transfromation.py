...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            numerical_columns=['TransactionAmount', 'TransactionTime', 'TransactionFrequency', 'PastFraudHistory', 'Velocity', 'DistanceFromLast', 'AmountRatio', 'AccountAge']
            categorical_columns=['TransactionType', 'MerchantCategory', 'TransactionLocation', 'DeviceType', 'SpendingPattern', 'CardPresent']
